...
import { BaseAxisProps, TickItem, PresentationAttributesAdaptChildEvent } from 'recharts/types/util/types';
...
export declare class PolarRadiusAxis extends PureComponent<Props> {
    ...
    getTickValueCoord({ coordinate }: TickItem): import("recharts/types/util/types").Coordinate;
