export declare const ComposedChart: {
    ...
    getDerivedStateFromProps: (nextProps: import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps, prevState: import("recharts/types/chart/types").CategoricalChartState) => import("recharts/types/chart/types").CategoricalChartState;
