...
import { AxisStackGroups } from 'recharts/types/util/ChartUtils';
import { AxisType, CategoricalChartOptions, ChartCoordinate, DataKey, LayoutType, Margin, StackOffsetType, TickItem, TooltipEventType } from 'recharts/types/util/types';
import { AccessibilityManager } from 'recharts/types/chart/AccessibilityManager';
import { AxisMap, CategoricalChartState } from 'recharts/types/chart/types';
...
export declare const generateCategoricalChart: ({ chartName, GraphicalChild, defaultTooltipEventType, validateTooltipEventTypes, axisComponents, legendContent, formatAxisMap, defaultProps, }: CategoricalChartOptions) => {
    new (props: CategoricalChartProps): {
        ...
        renderPolarAxis: (element: any, displayName: string, index: number) => React.DetailedReactHTMLElement<{
            ...
            dataKey?: DataKey<any>;
            hide?: boolean;
            scale?: Function | import("recharts/types/util/types").ScaleType;
