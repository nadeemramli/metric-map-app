import { Container, ContainerConfig } from 'konva/lib/Container.js';
import { SceneCanvas, HitCanvas } from 'konva/lib/Canvas.js';
import { GetSet, Vector2d } from 'konva/lib/types.js';
...
export declare class Stage extends Container<Layer> {
    ...
    getIntersection(pos: Vector2d): Shape<import("konva/lib/Shape.js").ShapeConfig> | null;
    _resizeDOM(): void;
    ...
    _getTargetShape(evenType: any): Shape<import("konva/lib/Shape.js").ShapeConfig> | null;
