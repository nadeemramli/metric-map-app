import { Node, NodeConfig } from 'konva/lib/Node.js';
import { GetSet, IRect } from 'konva/lib/types.js';
import { Shape } from 'konva/lib/Shape.js';
import { HitCanvas, SceneCanvas } from 'konva/lib/Canvas.js';
import { SceneContext } from 'konva/lib/Context.js';
...
export declare abstract class Container<ChildType extends Node = Node> extends Node<ContainerConfig> {
    ...
    clone(obj?: any): this;
    getAllIntersections(pos: any): Shape<import("konva/lib/Shape.js").ShapeConfig>[];
