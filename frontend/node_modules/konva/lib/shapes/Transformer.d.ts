...
import { ContainerConfig } from 'konva/lib/Container.js';
import { GetSet, IRect, Vector2d } from 'konva/lib/types.js';
...
export declare class Transformer extends Group {
    ...
    getNode(): Node<import("konva/lib/Node.js").NodeConfig>;
    _getEventNamespace(): string;
    setNodes(nodes?: Array<Node>): this;
    _proxyDrag(node: Node): void;
    getNodes(): Node<import("konva/lib/Node.js").NodeConfig>[];
